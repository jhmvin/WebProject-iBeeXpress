...
$packages = $package->where('archive','=','1');
 ?>
...
-->
	...
	<tr style = "height: 80px;line-height : 40px;background-color:#3B5998;color:white"> <td colspan = 7><h1 style = "padding-top:20px;padding-left: 0px;color:#FFFFFF">Package Delivery Archive</h1></td> </tr>
