...
$remittances = $remit->where('archive','=','0');
 ?>
...
<div class = "panel" id = "view_remit">
	...
	<tr style = "height: 80px;line-height : 40px;background-color:#3B5998;color:white"> <td colspan = 7><h1 style = "padding-top:20px;padding-left: 0px;color:#FFFFFF">Money Remittances</h1></td> </tr>
