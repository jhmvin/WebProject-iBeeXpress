...
$result=mysqli_query($con,"select trackno,sender_name,destination,delivery_date from package where state = 'DELIVERED'");
		...
		function Header()
{
		...
		$this->Cell(30,10,'Delivered Packages Report',0,0,'C');
		//Line break
		$this->Ln(20);
	}
...
$pdf->SetFont('helvetica','B',12);
$pdf->SetX(20);
$pdf->MultiCell(100,20,'Total Delivered Packages : '.$number_of_products,0,'L');
